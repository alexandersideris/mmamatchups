              ...
              <div className="container">
                <div className="row">
                  <div>
                    ...
                    <p style={{width: 1140, textAlign: 'center', fontSize: 20}}><b>"You need to do what you need to do, job is job." - Wanderlei Silva</b> ( Tribute to MMA Digest <Glyphicon glyph='heart'/> )</p>
                  </div>
                  <div>
                    {fights.map(function(fight){
                      return(
